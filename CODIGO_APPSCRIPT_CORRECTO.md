# Google Apps Script - Correo Cierre de Caja
...
1. **Copiar todo el código** del bloque `javascript` arriba
2. **Ir a Google Apps Script** (script.google.com)
3. **Crear nuevo proyecto** o abrir el existente
4. **Reemplazar el contenido** de `Código.gs` con el código copiado
5. **Guardar** (Ctrl+S)
6. **Desplegar** como Web App

### Parámetros esperados (desde POS):

```
https://script.google.com/macros/d/{DEPLOYMENT_ID}/usurp?cierre_id=123&total_ventas=1500.00&fecha_apertura=2026-05-09&fecha_cierre=2026-05-09%2015:30:00&caja=1&cajero_id=5
```
